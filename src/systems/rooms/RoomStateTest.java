...
public class RoomStateTest {
    ...
    private List<RoomStateTest> connectedRooms;
    ...
    public List<RoomStateTest> getConnectedRooms(){return connectedRooms;}

    /** Setter **/
    public void setEnemies(List<Enemy> enemies){this.enemies = enemies;}

    public void setConnectedRooms(List<RoomStateTest> connectedRooms) {this.connectedRooms = connectedRooms;}
